...
<h2>글쓰기</h2>
<form name="writeForm" enctype="multipart/form-data" method="post" action="<%=request.getContextPath()%>/writeFileProc.bo">
	<table border="1" width="90%">
		...
		<tr><td>File</td><td><input type="file" name="attachedFile" style="width:90%"></td></tr>
	</table>
